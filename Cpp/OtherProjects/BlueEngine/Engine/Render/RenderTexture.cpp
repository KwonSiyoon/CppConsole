...
namespace Blue
{
    ...
    {
        // RenderTarget View. ShaderResource View. DepthStencil View.
        ...
        // 생성.
        ThrowIfFailed(device.CreateTexture2D(&textureDesc, nullptr, &renderTargetResource), TEXT("Failed to create texture2D for render texture."));
        ...
        ThrowIfFailed(device.CreateRenderTargetView(renderTargetResource, &renderTargetViewDesc, &renderTargetView), TEXT("Failed to create render target view for render texture."));
        ...
        ThrowIfFailed(device.CreateShaderResourceView(renderTargetResource, &shaderResourceViewDesc, &textureData->shaderResourceView), TEXT("Failed to create shader resource view for render texture."));
        ...
        ThrowIfFailed(device.CreateSamplerState(&sampleDesc, &textureData->samplerState), TEXT("Failed to create sampler state for render texture."));
